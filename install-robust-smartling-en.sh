...
if [[ $# -eq 2 ]]; then
    ...
    echo "   ./install-robust-smartling-en.sh \"USER_ID\" \"USER_SECRET\""
    echo ""
...
echo ""
echo "🚀 Ready to use Smartling with Claude and Cursor!" 